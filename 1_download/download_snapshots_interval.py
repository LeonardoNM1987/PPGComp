...
def download_ribs_files(start_year, start_month, end_year, end_month, download_dir):
    base_url = 'https://routeviews.org/route-views2.saopaulo/bgpdata'
    day = 15
    hour = 2200
...
download_directory = r"E:\Mestrado\Ribs\2ndsp2018a2020"

# Chamada da função para o intervalo desejado
download_ribs_files(2019, 6, 2020, 4, download_directory)
