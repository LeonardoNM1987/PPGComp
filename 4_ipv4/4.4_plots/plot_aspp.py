...
sourceBatch = [
    'ipv4/3_results/resultados_teste/rib.20110320.0000_ipv4_results.txt',
    'ipv4/3_results/resultados_teste/rib.20130320.0000_ipv4_results.txt',
    'ipv4/3_results/resultados_teste/rib.20150320.0000_ipv4_results.txt',
    'ipv4/3_results/resultados_teste/rib.20170320.0000_ipv4_results.txt',
    'ipv4/3_results/resultados_teste/rib.20200320.0000_ipv4_results.txt'    
]
...
# Plotando os dados
plt.plot(dates, fractionTotalPreps, label='Total de Prepends')
plt.plot(dates, fractionPrepsOrigem,  label='Prepends na Origem')
...
plt.legend()
plt.grid(True)
plt.savefig('ipv4/4_plots/Figure2.png')
# Exibindo o gráfico
plt.show()
