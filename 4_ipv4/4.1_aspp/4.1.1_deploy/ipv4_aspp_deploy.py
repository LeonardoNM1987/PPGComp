...
bogonsList = '4_ipv4/bogonsList.txt'
source = '3_source_files/3.1_snapshots\saopaulo2nd/2ndsp2018a2020'   # AJUSTAR source DE OUTPUT TAMBÉM!! 
output_path = '5_ipv4_results/5.1_aspp/5.1.1_deploy/'
...
######################## OUTPUT PARA source RESULTS #########################
    ...
    output = (f'{output_path}{nomeSemExtensao}_results.txt')
