...
#source = '3_source_files/3.1_snapshots/saopaulo2nd/2ndsp2018a2020'   #sp2nd
#source = '3_source_files/3.1_snapshots/singapore/2018to2020'  #singapore
source = '3-source_files/3.1_snapshots/ams-ix/2018to2020'   #amsterdam
output_path = '4-ipv4_aspp_deploy/4.2-results'
#'5ipv4_results/5.1_aspp/5.1.1_deploy/ams-sp-sg'
...
######################## OUTPUT PARA source RESULTS #########################
    ...
    #output = (f'{output_path}/2ndsp.{nomeSemExtensao}_first_results.txt') #sp
    #output = (f'{output_path}/sg.{nomeSemExtensao}_first_results.txt') #sg
    output = (f'{output_path}/ams.{nomeSemExtensao}_first_results.txt') #ams-ix
    with open(output, 'w') as arquivoResultados:
        ...
        arquivoResultados.write(f'{conjPrefixosUnicos}\n')               #21 # DAQUI PARA BAIXO É PARA ANALISE DAS POLITICAS DE PREFIXOS
