...
bogonsList = './2_analises/bogonsList.txt'                                  # lista de rotas bogon
...
sourceBatch = ['1_source/rib.20110320.0000.txt',
               '1_source/rib.20130320.0000.txt',
               '1_source/rib.20150320.0000.txt',
               '1_source/rib.20170320.0000.txt',
               '1_source/rib.20200320.0000.txt']
#sourceBatch = ['1_source/rib.20110320.0000.txt']
...
######################## OUTPUT PARA PASTA RESULTS #########################
    ...
    output = (f'./3_results/{nomeSemExtensao}_ipv4_results.txt')
...
# 22 - Conjunto de prefixos unicos visualizados no snapshot
